...
import com.mymemo.app.activities.RecordAudio
import com.mymemo.app.audio.Status.PAUSED
import com.mymemo.app.audio.Status.READY
import com.mymemo.app.audio.Status.RECORDING
...
class AudioRecordService : Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "com.mymemo.app.audio"
