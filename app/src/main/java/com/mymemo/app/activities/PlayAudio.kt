...
import com.mymemo.app.audio.AudioPlayService
import com.mymemo.app.audio.LocalBinder
import com.mymemo.app.databinding.ActivityPlayAudioBinding
...
class PlayAudio : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        audio = requireNotNull(intent.getSerializableExtra(AUDIO) as? Audio)
