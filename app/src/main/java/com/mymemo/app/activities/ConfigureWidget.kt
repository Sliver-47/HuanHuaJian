...
import com.mymemo.app.databinding.ActivityConfigureWidgetBinding
import com.mymemo.app.miscellaneous.IO
import com.mymemo.app.preferences.Preferences
import com.mymemo.app.preferences.View
import com.mymemo.app.recyclerview.ItemListener
import com.mymemo.app.recyclerview.adapter.BaseNoteAdapter
...
class ConfigureWidget : AppCompatActivity(), ItemListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val database = MyMemoDatabase.getDatabase(application)
