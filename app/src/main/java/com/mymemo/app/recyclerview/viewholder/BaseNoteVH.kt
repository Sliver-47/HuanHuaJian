...
import com.mymemo.app.databinding.RecyclerBaseNoteBinding
import com.mymemo.app.miscellaneous.Operations
import com.mymemo.app.miscellaneous.applySpans
import com.mymemo.app.preferences.DateFormat
    ...
    private fun setImages(images: List<Image>, mediaRoot: File?) {
        if (images.isNotEmpty()) {
            ...
            Glide.with(binding.ImageView)
                ...
                .override(200, 200) // 限制图片大小，减少内存占用
    ...
    private fun setReminder(reminder: Reminder?) {
        if (reminder != null) {
            ...
            binding.Reminder.text = when (reminder.frequency) {
                ...
                Frequency.WEEKDAY -> context.getString(R.string.repeats_weekday, date)
                Frequency.WEEKLY -> context.getString(R.string.repeats_weekly, date)
                Frequency.MONTHLY -> context.getString(R.string.repeats_monthly, date)
                Frequency.YEARLY -> context.getString(R.string.repeats_yearly, date)
            }
