package com.mymemo.app.core.service
...
class AttachmentDeleteService : Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "com.mymemo.app.fileUpdates"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        scope.launch {
            val list = requireNotNull(intent).getSerializableExtra(EXTRA_ATTACHMENTS) as? ArrayList<Attachment>
            withContext(Dispatchers.IO) {
