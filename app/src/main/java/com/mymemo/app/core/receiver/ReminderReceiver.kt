package com.mymemo.app.core.receiver
...
class ReminderReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        private fun sendNotification(context: Context, baseNote: BaseNote) {
            ...
            builder.setSmallIcon(com.mymemo.app.R.drawable.reminder)
            ...
            when (baseNote.type) {
                Type.NOTE -> {
                    body = baseNote.body
                    empty = context.getString(com.mymemo.app.R.string.empty_note)
                }
                Type.LIST -> {
                    body = Operations.getBody(baseNote.items)
                    empty = context.getString(com.mymemo.app.R.string.empty_list)
                }
            }
